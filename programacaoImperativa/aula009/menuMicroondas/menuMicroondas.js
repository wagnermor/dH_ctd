...
console.log(`Opção 2 e tempo alterado: ${Microondas(2, 15)}`);
...
console.log(`Opção 3 e tempo alterado: ${Microondas(3, 29)}`);
...
console.log(`Opção 4 e tempo alterado: ${Microondas(4, 23)}`);
...
console.log(`Opção 5 e tempo alterado: ${Microondas(5, 15)}`);
